...
const AccordionCard = () => {
  const dataFooter = [
    ...
    {
      title: 'Masalah apa saja yang bisa saya ceritakan/konsultasikan?',
  ...
  return (
    <div className="max-w-3xl py-10 mx-auto container">
      <h1 className="text-center text-color-palette-5 font-bold lg:text-3xl lg:mb-6">
